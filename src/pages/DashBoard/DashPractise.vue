    ...
    <div class="newMember w-100 my-3 ">
       <div class="container">
         <div class="banner d-flex justify-content-between">
            <div class="title">
                <img src="@/assets/images/list/game.png" alt="">المستويات
            </div>
            <div class="btn" @click="openModal('newLevelMode')">+ اضف مستوى جديد</div>
        </div>
        <div class="box mt-5">
            <div class="admins d-flex justify-content-between" v-for="admin in admins" :key="admin.id">                                                            
                <div class="right">
                    <div class="circle one"></div>
                    <router-link :to="{name:'activity', params: {id:admin.id}}"><span style="color: black">{{ admin.name }}</span></router-link>
                </div>   
                <div class="left">
            ...
            <form class="row g-3 " @submit.prevent="addLevel()">
                <div class="row" style="position: relative;">
                    ...
                    <div class="col-12 mx-auto">
                        <div class="title text-center">اضافة مستوى جديد</div>
                    </div>
                </div>
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">اسم المستوى</label>
                    <input type="text" v-model="email" class="form-control" id="inputName4">
                </div>
                 <div class="col-12 mx-auto">
...
export default {
    ...
    methods: {
        ...
        addLevel() {
            ...
            axios.post('http://127.0.0.1:8000/api/addLevel', {
                name: this.email,
            }, {
                headers: {
        ...
        deleteRole(id){
            ...
            swal.fire({
                ...
                if(alertResult.isConfirmed){
                    console.log('delete');
                axios.delete(`http://127.0.0.1:8000/api/deleteLevel/${id}`, {
                headers: {
                    Authorization: `Bearer ${this.token}`,
                },
            }).then(() => {
