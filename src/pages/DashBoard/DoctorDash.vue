    ...
    <div class="newMember w-100 my-3 ">
       <div class="container">
         <div class="banner d-flex justify-content-between">
            <div class="title">
                <img src="@/assets/images/doc/Vector.png" alt="">الاطباء
            </div>
        </div>
        <div class="box mt-5">
            <div class="admins d-flex justify-content-between" v-for="doctor in doctors" :key="doctor.id">                                                            
                ...
                <div class="left">
                    <div class="subscribe">مشترك</div>
                    <img src="@/assets/images/list/trash.png" alt="">
                </div>
            </div>
        </div>
       </div>
...
export default {
    ...
    methods: {
        ...
        getDoctors(){
            axios.get('http://127.0.0.1:8000/api/all-doctors', {
            headers: {
                Authorization: `Bearer ${this.token}`,
            },
        }).then((res) => {
